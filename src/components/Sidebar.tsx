...
export const Sidebar = ({ open, onClose, onClear, onNewChat, children }: Props) => {
  return (
    ...
    >
      ...
      >
        <div className='flex flex-col w-64 p-2 bg-gpt-dark'>
          <div
            onClick={onNewChat} className='flex items-center p-3 rounded-md 
        ...
        <div
          onClick={onClose}
          className='flex justify-end items-center w-10 h-10 cursor-pointer md:hidden'
        >
